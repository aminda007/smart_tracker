...
public class CoordinateList extends AsyncTask<String,Void,String []> {

    private MainActivity main;
    private ProgressDialog dialog;

    public CoordinateList(MainActivity main){
        this.main =main;
    }
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            URL url = new URL(main.getApplicationContext().getResources().getString(R.string.IP_ADDRESS )+ main.getApplicationContext().getResources().getString(R.string.CORDINATE_LIST));
